...
import './db/myLocation.dart';
import './widgets/side_drawer.dart';

void checkCurrentPosition() async {
  final DateTime now = DateTime.now();
  final int isolateId = Isolate.current.hashCode;
  print("[$now] Hello, Stampbook! isolate=$isolateId");
  MyLocationData.myLoc.getLoc();
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Platform message are asyncchronous, so we initialize in an async method.
  Future<void> _initPlatformState() async {
    EventData.event.insert('Init', '{}');
    /*try {
